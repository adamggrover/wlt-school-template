...
<?php
  ...
  if( $accordionItems): 
    ...
    foreach ($accordionItems as $accordionItem) :  ?>
      ...
      <div class="accordion-item mb-0" id="accordionFlushExample<?php echo $collapseId ?>">
        <h2 class="accordion-header mb-0" id="flush-heading<?php echo $collapseId ?>">
        ...
        <div id="flush-collapse<?php echo $collapseId ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading<?php echo $collapseId ?>" data-bs-parent="#accordionFlushExample<?php echo $collapseId ?>">
          <div class="accordion-body mb-0"><?php echo $accordionItem['accordion_item_body'] ?></div>
        </div>
      </div>
      <?php
